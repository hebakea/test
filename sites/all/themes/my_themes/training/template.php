...
function training_preprocess_page(&$vars, $hook) {
  ...
  //$vars['mikes_variable'] = format_date('long',time());
}
...
function _training_feed_icon($variables) {
  $text = t('ckasjdsalkdjlkj sSubscribe to @feed-title', array('@feed-title' => $variables['title']));
...
function training_form_required_marker($variables) {
